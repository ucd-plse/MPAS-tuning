...
export REPO_ROOT=<REPLACE_WITH_PATH_TO_REPO_ROOT>
...
cd src/framework
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -O3 -convert big_endian -free -align array64byte -real-size 64 -c mpas_log.F90 -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I../external/esmf_time_f90
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -O3 -convert big_endian -free -align array64byte -real-size 64 -c mpas_pool_routines.F90 -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I../external/esmf_time_f90
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -O3 -convert big_endian -free -align array64byte -real-size 64 -c mpas_dmpar.F90 -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I../external/esmf_time_f90
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -O3 -convert big_endian -free -align array64byte -real-size 64 -c mpas_timekeeping.F90 -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I../external/esmf_time_f90
...
cd operators
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -O3 -convert big_endian -free -align array64byte -real-size 64 -c mpas_vector_reconstruction.F90 -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I../framework -I../external/esmf_time_f90
...
cd dynamics
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -DDO_PHYSICS -O3 -convert big_endian -free -align array64byte -real-size 64 -c mpas_atm_boundaries.F90 -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I.. -I../../framework -I../../operators -I../physics -I../physics/physics_wrf -I../../external/esmf_time_f90
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -DDO_PHYSICS -O3 -convert big_endian -free -align array64byte -real-size 64 -c mpas_atm_iau.F90 -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I.. -I../../framework -I../../operators -I../physics -I../physics/physics_wrf -I../../external/esmf_time_f90
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -DDO_PHYSICS -O3 -convert big_endian -free -align array64byte -real-size 64 -c mpas_atm_time_integration.F90 -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I.. -I../../framework -I../../operators -I../physics -I../physics/physics_wrf -I../../external/esmf_time_f90
cd ..
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -DDO_PHYSICS -O3 -convert big_endian -free -align array64byte -real-size 64 -c mpas_atm_core.F90 -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I./inc -I../framework -I../operators -I./physics -I./dynamics -I./diagnostics -I./physics/physics_wrf -I../external/esmf_time_f90
...
rm -f *.o *.mod *.f90
rm -f *.i
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -O3 -convert big_endian -free -align array64byte -real-size 64 -c mpas_subdriver.F -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I../framework -I../operators -I../core_atmosphere -I../external/esmf_time_f90
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -O3 -convert big_endian -free -align array64byte -real-size 64 -c mpas.F -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I../framework -I../operators -I../core_atmosphere -I../external/esmf_time_f90
cd ..
mpif90 -O3 -o atmosphere_model driver/*.o -L. -ldycore -lops -lframework -L/glade/u/apps/ch/opt/pio/1.10.1/mpt/2.25/intel/2022.1//lib -lpio -L/glade/u/apps/ch/opt/netcdf/4.8.1/intel/2022.1//lib -lnetcdff -lnetcdf -L/glade/u/apps/ch/opt/pnetcdf/1.12.2/mpt/2.25/intel/2022.1//lib -lpnetcdf -I./external/esmf_time_f90 -L./external/esmf_time_f90 -lesmf_time
cd ..
