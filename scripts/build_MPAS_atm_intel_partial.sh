...
rm -f *.o *.mod *.f90
rm -f *.i
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -O3 -convert big_endian -free -align array64byte -march=core-avx2 -real-size 64 -c mpas_subdriver.F -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I../framework -I../operators -I../core_atmosphere -I../external/esmf_time_f90
mpif90 -D_MPI -DCORE_ATMOSPHERE -DMPAS_NAMELIST_SUFFIX=atmosphere -DMPAS_EXE_NAME=atmosphere_model -DMPAS_NATIVE_TIMERS -DMPAS_GIT_VERSION=v7.3-46-g87389418-dirty -O3 -convert big_endian -free -align array64byte -march=core-avx2 -real-size 64 -c mpas.F -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I${PIO_INCLUDE} -I${NETCDF_INCLUDE} -I${PNETCDF_INCLUDE} -I../framework -I../operators -I../core_atmosphere -I../external/esmf_time_f90
cd ..
